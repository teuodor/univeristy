...
public class StartRpcServer {
    ...
    public static void main(String[] args){
        ...
        try{
            serverProps.load(StartRpcServer.class.getResourceAsStream("competitorserver.properties"));
        ...
        EmployeeRepository employeeRepository = new EmployeeRepository("competitorserver.properties");
        EventRepository eventRepository = new EventRepository("competitorserver.properties");
        CompetitorRepository competitorRepository = new CompetitorRepository("competitorserver.properties");
