...
class IteratorColectie:
    ...
    def valid(self):
        return self.__curent < len(self.__c._Colectie__perechi)
    ...
    def element(self):
        ...
        return self.__c._Colectie__perechi[self.__curent][0]
    ...
    def urmator(self):
        ...
        frec = self.__c._Colectie__perechi[self.__curent][1] 
        
        if self.__frecv_curenta < frec:
            self.__frecv_curenta += 1
